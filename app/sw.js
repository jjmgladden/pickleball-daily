...
const CACHE = 'pickleball-daily-v20';
...
const SHELL_FILES = [
  ...
  './js/components/player-compare.js',
  './js/components/sparkline.js',
  './js/components/splash.js',
  './js/components/sub-tab-strip.js',
  './js/tabs/daily.js',
  './js/tabs/live.js',
  './js/tabs/tournaments.js',
  './js/tabs/teams.js',
  './js/tabs/players.js',
  './js/tabs/player-detail.js',
  './js/tabs/rankings.js',
  './js/tabs/ratings.js',
  './js/tabs/stats.js',
  ...
  './js/tabs/news.js',
  './js/tabs/learn.js',
  './js/tabs/gear-courts.js',
  './js/tabs/equipment.js',
  './js/tabs/ask.js'
];
